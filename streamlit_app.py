...
QA_template = """
    ...
    Your job is to evaluate the output of the question generator (Question and the corresponding rubric) and ensure that they meet or exceed quality standards using the following rubric.
