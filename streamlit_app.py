...
def load_question_display():        
        ...
        #load_question_display()
        st.session_state.answer = st.text_area(label=" ",on_change=generate_feedback_button_click, placeholder="Type your response here...2000 words max", key="answer_input", height=500)
        #if len(input_answer.split(" ")) > 2000:
            #st.write("Please enter a shorter answer. The maximum length is 2000 words.") 
